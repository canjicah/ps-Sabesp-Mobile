...
export default function Home({navigation}: NavigationProps){
    ...
    useEffect(() => {
        async function carregarDados(){
            const resposta = await axios.get<Response>('https://api.themoviedb.org/3/trending/tv/week?api_key=1e922667481ab207d642450b0efb461e')
    ...
    return (
        <Container>
            <Header>
                <PosterHeader 
                source={{ uri: 'https://www.themoviedb.org/t/p/w500/uAWB8qOs7L6zGTwxAbeT97AsJk6.jpg'}} />
            ...
            <SecaoFilmes>
                <ListaHorizontal data={filmes} renderItem={ ({item}) => 
                    <CardFilme onPress={() => handleDetail(item)}>
                        <Poster source={{ uri: 'https://image.tmdb.org/t/p/w200/' + item.poster_path}}/>
                        <Avaliacao>
                            <Icon name="star" />
